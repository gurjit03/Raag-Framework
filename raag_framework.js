...
////// WITH sound.js file, this commented out code too.
...
function createMusic(object) {
    
    var notation = object.notation;
    var selectedLanguage = object.language;
...
function playNotation(notationArray,selectedLanguage,tempoGiven,taal) {
    ...
    tempo = tempoGiven || 60;
    tempo = Number((1000/Number((tempoGiven / 60).toFixed(2))).toFixed(2))
    console.log(tempo);
    stoptime = tempo + 250;
